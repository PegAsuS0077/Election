...
export const UI: Record<string, { np: string; en: string }> = {
  ...
  projectedGovt:      { np: "बहुमत सीमा (≥ {n} सिट) पार गर्‍यो।", en: "has crossed the majority mark (>= {n} seats)." },
  live:               { np: "अन्तिम",                         en: "FINAL" },
  ...
  stillCounting:      { np: "निर्वाचन क्षेत्र घोषणा हुन बाँकी।", en: "constituencies not yet declared." },
  ...
  preElection:        { np: "अद्यावधिक उपलब्ध छैन",                en: "No declared result yet" },
  ...
  hotSeatsEmpty:      { np: "उपलब्ध अन्तिम डेटाबाट कडा प्रतिस्पर्धा फेला परेन।", en: "No close-race entries were found in the archived results." },
